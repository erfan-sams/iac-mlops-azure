...
5.  **Provision Infrastructure:** cd infra && tofu init && tofu apply -auto-approve
...
3.  **Destroy Tofu-Managed Infrastructure:** Remove the core infrastructure components managed by OpenTofu.
    *   **Option A (Recommended - Tofu CLI):** Navigate to the infra/ directory in your terminal and run:
